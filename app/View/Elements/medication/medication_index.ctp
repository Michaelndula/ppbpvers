            ...
            <?php 
              if($medication['Medication']['submitted'] > 1) {
                ...
                if($redir == 'manager' && empty($medication['Medication']['vigiflow_ref'])  && $medication['Medication']['copied'] == 2) echo $this->Html->link('<span class="label label-warning tooltipper" title="Send to vigiflow"><i class="fa fa-paper-plane-o" aria-hidden="true"></i> Vigiflow </span>' ,
                  ...
                  array('escape' => false));
                echo "&nbsp;";
                if($redir == 'manager' && $medication['Medication']['copied'] == 2) echo $this->Html->link('<span class="label label-success tooltipper" title="Copy & Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit </span>' ,
